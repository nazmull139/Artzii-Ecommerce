    ...
    <div className='container max-w-7xl mx-auto px-4 '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-3'>
            <div>
                ...
                <p className='pb-4'><strong>Phone:</strong>+1 (123) 456,7890</p>
                <p className='pb-4'><strong>Adress:</strong>1234 Street Name , City , Country</p>
            ...
            <div>
                <form className='bg-white shadow-md rounded-lg p-6'>
                    ...
                    <div>
                        <button className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 bg-secondary text-white bg-red-600'>
                            Send Message
                        </button>
                    </div>
                </form>
